...
namespace TechParser.Storage
{
    ...
    public interface IStorage
    {
        ...
        List<ParseFile> GetParseFiles(int resId);
        void AddFile(ParseFile file);
    ...
    public class Storage : IStorage
    {
        ...
        public List<ParseFile> GetParseFiles(int resId) => _parserDbContext.ParseFiles
            .Where(file => file.ResurceId == resId)
            .Select(file => file).ToList();

        public void AddFile(ParseFile file)
        {
            _parserDbContext.ParseFiles.Add(file);
            _parserDbContext.SaveChanges();
        }
